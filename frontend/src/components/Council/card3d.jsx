"use client"; // remove this line if you're on Pages Router, not App Router
...
export const useMouseEnter = () => {
  ...
  if (context === undefined) throw new Error("useMouseEnter must be used within CardContainer");
  return context;
};