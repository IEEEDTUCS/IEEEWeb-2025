...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-gray-950 text-gray-300 pt-10 pb-6 relative z-50 font-sans">
        ...
        <div>
          ...
          <div className="space-y-2 text-sm">
            <p className="flex items-center gap-2">
              <Phone size={16} className="text-blue-400" /> +91 93552 57413
            </p>
            <p className="flex items-center gap-2">
              <Phone size={16} className="text-blue-400" /> +91 72178 61438
            </p>
            <p className="flex items-center gap-2">
              <Phone size={16} className="text-blue-400" /> +91 95606 47659
            </p>
          </div>
